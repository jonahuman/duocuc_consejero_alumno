<!--
este es el layout para consejero de carrera, a partir de este layout o plantilla se muestra la "vista" hacía el usuario con derechos de administrador
-->
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
    <title>FURYUM | Panel de Consejero</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>FURYUM</b></span>
        </a>
...
<div class="user-panel">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="./?view=users"><i class='fa fa-user'></i> <span>Alumnos</span></a></li>
            <?php endif; ?>
    ...
    <?php endif;?>
      ...
      <div class="content-wrapper">
        ...
        <strong>Copyright &copy; 2022 <a href="https://www.duoc.cl/sedes/alonso-ovalle/" target="_blank">DuocUc PAO</a></strong>
      </footer>
      <?php else:?>
